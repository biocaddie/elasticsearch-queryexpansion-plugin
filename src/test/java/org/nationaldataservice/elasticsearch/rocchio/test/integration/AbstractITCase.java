...
public abstract class AbstractITCase {
	...
	protected static void wait(int millis) {
		staticLogger.debug(String.format("Sleeping for %d milliseconds", millis));
		try {
			Thread.sleep(millis);
	...
	/**
	 * The {@link NamedXContentRegistry} to use for this test. Subclasses should
	 * override and use liberally.
	 */
